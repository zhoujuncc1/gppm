...
public:
    ...
    void setChild1(Node* node) { this->child1 = node; }

    void setChild2(Node* node) { this->child2 = node; }

    void setTimeLimit(int* timeLim) { this->timeLimit = timeLim; }
...
public:
    ...
    int evalNode()
    {
        ...
        if ((this->isLast) || ((*timeLimit > 0) && (this->time == *timeLimit))) {
            this->known = 1;
            this->truth = tf;
            return tf;
        } else {
