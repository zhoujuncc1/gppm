...
typedef boost::variate_generator<RandomNumberGenerator&, NumberDistribution>
    Generator;
...
public:
    ...
    float* getTrajectories_device() { return trajectories_device; }

    float* getTrajectories_host() { return trajectories_host; }
