...
const int Model::N_SPECIES = 32;
const int Model::N_PARAMS = 48;
const double Model::end_time = 62.0;
const double Model::x_variation = 0.05;

const double Model::x[Model::N_SPECIES] = { 10002000, 456000, 80000, 0, 10000, 0,
		120000, 0, 120000, 0, 120000, 0, 120000, 120000, 0, 120000, 0, 600000,
		0, 600000, 0, 120000, 0, 120000, 0, 120000, 0, 120000, 0, 120000,
		120000, 120000 };


const double Model::p[Model::N_PARAMS] = { 2.185e-005, 0.012101, 1.3821e-007, 0.0072381,
		694.731, 6086070, 389.428, 2112.66, 1611.97, 896896, 32.344, 35954.3,
		1509.36, 1432410, 0.8841, 62464.6, 185.759, 4768350, 125.089, 157948,
		2.8324, 518753, 9.8537, 1007340, 8.8912, 3496490, 0.02137, 763523,
		10.6737, 184912, 0.077107, 272056, 0.056628, 653951, 15.1212, 119355,
